...
export default function TicketCard({ ticket, employees, isSuperAdmin, currentEmployeeId, onUpdate, onReassign }: Props) {
  ...
  const canReassign = isSuperAdmin || ticket.assigned_to === currentEmployeeId;
