...
import { Plus, Search, Users, Ticket as TicketIcon, Filter } from 'lucide-react';
...
export default function TicketDashboard() {
  ...
  // Derive per-employee ticket counts for the left panel
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h2 className="text-xl font-semibold text-primary">Ticket Dashboard</h2>
